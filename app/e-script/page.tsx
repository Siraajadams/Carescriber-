  ...
  return (
    <main style={styles.page}>
      <section style={styles.card}>
        ...
        <p style={styles.subtitle}>Search ICD-10, select medicines from the SA price database, issue a prescription and export a compact professional A4 prescription PDF.</p>
